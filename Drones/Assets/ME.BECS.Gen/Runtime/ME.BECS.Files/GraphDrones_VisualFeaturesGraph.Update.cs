namespace ME.BECS {
    ...
    public static unsafe class GraphGraphDrones_VisualFeaturesGraphUpdate {
        // BURST ENABLE OPEN
        ...
        public static void GraphOnUpdate_1001_SystemsCodeGenerator(uint dt, ref World world, ref Unity.Jobs.JobHandle dependsOn) {
            ...
            var systems = (System.IntPtr*)GraphGraphDrones_VisualFeaturesGraphInitialize.graphNodes1001_SystemsCodeGenerator.GetUnsafePtr();
