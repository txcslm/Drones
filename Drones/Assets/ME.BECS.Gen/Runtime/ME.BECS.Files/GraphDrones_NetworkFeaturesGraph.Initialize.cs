namespace ME.BECS {
    ...
    public static unsafe class GraphGraphDrones_NetworkFeaturesGraphInitialize {
        ...
        public static void GraphInitialize_1002_SystemsCodeGenerator() {
            ...
            {
                var item = allocator.Allocate(TSize<Source.Drones.Code.Systems.ExampleSystem>.sizeInt, TAlign<Source.Drones.Code.Systems.ExampleSystem>.alignInt);
                *(Source.Drones.Code.Systems.ExampleSystem*)item = new Source.Drones.Code.Systems.ExampleSystem {
                }
                ;
                TSystemGraph.Register<Source.Drones.Code.Systems.ExampleSystem>(1002, item);
